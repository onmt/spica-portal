...
| **ライセンス方式は 0007 で改訂（2026-07-12）**：Free/Solo＝オフライン署名・通信ゼロ（0004 のまま）／Pro・ボリューム＝オンライン保護 — **ユーザー操作時のみ**鍵＋非可逆機器ハッシュを送信・裏送信なし・**通信履歴をアプリ内で全件開示**・オフライン猶予90日・失効は限定列挙（本人依頼/チャージバック/大規模流出のみ・ベンダー都合の遠隔無効化はしない）。旧文言「ライセンス認証すら通信しない」は 2026-07-12 に LP から撤去 | prompter/ セキュリティ節・機能比較表ライセンス行 | `onmt/spica` `decisions/0007-license-revocable-protection.md`・`docs/license-protocol.md` §4.1 | ✅ | 2026-07-12 |
